...
class ExercisesClient(APIClient):
    ...
    def get_exercises_api(self, query: GetExercisesQuerySchema) -> Response:
        ...
        """
        return self.get("/exercises", params=query.model_dump(by_alias=True))
    ...
    def create_exercise_api(self, request: CreateExerciseRequestShema) -> Response:
        ...
        :return: Ответ от сервера в виде объекта httpx.Response
        """
        return self.post("/exercises", json=request.model_dump(by_alias=True))
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> Response:
        ...
        :return: Ответ от сервера в виде объекта httpx.Response
        """
        return self.patch(f"/exercises/{exercise_id}", json=request.model_dump(by_alias=True))
