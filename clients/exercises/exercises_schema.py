...
class CreateExerciseRequestShema(BaseModel):
    """
...
class CreateExerciseResponseShema(BaseModel):
    """
...
class UpdateExerciseResponseShema(BaseModel):
    """
    Описание структуры ответа обновления задания.
    """
    exercise: ExerciseSchema

class GetExerciseResponseShema(BaseModel):
    """
